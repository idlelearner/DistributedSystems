...
public class ByteWrapper implements Serializable {
	...
	public ByteWrapper addition(byte[] secNumber)
	{
	...
	public ByteWrapper powerOfTwo(int k)
	{
		int i, byteSize;
		byte[] array = null;
		String s = "1", t;
		...
		return new ByteWrapper(array);
	}
	
	public ByteWrapper subtraction(byte[] secNumber)
	{
		int carry = 0;
	...
	{
		ByteWrapper bgM = this.powerOfTwo(m);
		ByteWrapper bg;
	...
	public ByteWrapper addpowerOfTwo(int k)
	{
	...
	public ByteWrapper binaryToBigInt(String s)
	{
		int size = s.length();
	...
	public ByteWrapper shiftLeft(int shiftValue)
	{
		...
		ByteWrapper big = binaryToBigInt(s);

		return big;

	}

	public ByteWrapper shiftRight(int shiftValue)
	{
